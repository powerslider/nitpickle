...
Global preferences at `~/.claude/nitpickle/preferences.md` and the engineering
principles at `~/.claude/nitpickle/principles.md` already apply through config
...
`~/.claude/nitpickle/principles.md`), tell the user to seed them once with the
